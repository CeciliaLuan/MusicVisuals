...
public class stars extends Visual {
    ...
    public void setup() {
        ...
        player = minim.loadFile("MusicVisuals/java/data/experience.mp3", 512);
        player.play();
    ...
    void drawDaisy() {
        ...
        // Map the amplitude value to a range of values that will control the size of the center circle
